...
From these plots, it appears that chlorides and sulphates have a small number of high outliers.
...
```{r echo=FALSE}
get_simple_boxplot <- function(column) {
  return(qplot(data = df, x = 'simple',
               y = column, geom = 'boxplot',
               xlab = ''))
}

grid.arrange(get_simple_boxplot(df$fixed.acidity),
             get_simple_boxplot(df$volatile.acidity),
             get_simple_boxplot(df$citric.acid),
             get_simple_boxplot(df$TAC.acidity),
             get_simple_boxplot(df$residual.sugar),
             get_simple_boxplot(df$chlorides),
             get_simple_boxplot(df$free.sulfur.dioxide),
             get_simple_boxplot(df$total.sulfur.dioxide),
             get_simple_boxplot(df$density),
             get_simple_boxplot(df$pH),
             get_simple_boxplot(df$sulphates),
             get_simple_boxplot(df$alcohol),
             ncol = 4)
```
...
get_bivariate_boxplot <- function(x, y, xlab, ylab) {
  return(qplot(data = df, x = x, y = y, geom = 'boxplot'))
}
...
correlations <- c(
  simple_cor_test(df$fixed.acidity, as.numeric(df$quality)),
  simple_cor_test(df$volatile.acidity, as.numeric(df$quality)),
  simple_cor_test(df$citric.acid, as.numeric(df$quality)),
  simple_cor_test(df$TAC.acidity, as.numeric(df$quality)),
  simple_cor_test(log10(df$residual.sugar), as.numeric(df$quality)),
  simple_cor_test(log10(df$chlorides), as.numeric(df$quality)),
  simple_cor_test(df$free.sulfur.dioxide, as.numeric(df$quality)),
  simple_cor_test(df$total.sulfur.dioxide, as.numeric(df$quality)),
  simple_cor_test(df$density, as.numeric(df$quality)),
  simple_cor_test(df$pH, as.numeric(df$quality)),
  simple_cor_test(log10(df$sulphates), as.numeric(df$quality)),
  simple_cor_test(df$alcohol, as.numeric(df$quality)))
