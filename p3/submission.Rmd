...
grid.arrange(ggplot(data = df, aes(x = quality, y = fixed.acidity,
                                   fill = quality)) + 
               ggtitle('Fixed Acidity in Different Wine Quality') +
               ylab('Fixed Acidity (g/dm^3)') +
               xlab('Quality') +
               geom_boxplot(),
             ggplot(data = df, aes(x = quality, y = volatile.acidity,
                                   fill = quality)) +
               ggtitle('Volatile Acidity in Different Wine Quality') +
               ylab('Volatile Acidity (g/dm^3)') +
               xlab('Quality') +
               geom_boxplot(), 
             ggplot(data = df, aes(x = quality, y = citric.acid,
                                   fill = quality)) +
               ggtitle('Citric Acidity in Different Wine Quality') +
               ylab('Citric Acid (g/dm^3)') +
               xlab('Quality') +
               geom_boxplot(), 
             ggplot(data = df, aes(x = quality, y = pH,
                                   fill = quality)) +
               ggtitle('pH in Different Wine Quality') +
               ylab('pH') +
               xlab('Quality') +
               geom_boxplot())
...
ggplot(data = subset(df, rating != 'average'), aes(x = volatile.acidity, y = alcohol,
                      color = rating)) +
  geom_point() +
